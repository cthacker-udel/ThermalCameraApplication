...
import com.example.thermalapplication.databinding.ActivityDisplayPostBinding;
...
public class DisplayPost extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_content_display_post);
